...
static struct reg_value ov5640_init_setting_30fps_VGA[] = {
	{0x3008, 0x42, 0, 0},
	{0x3103, 0x03, 0, 0}, {0x3017, 0xff, 0, 0}, {0x3018, 0xff, 0, 0},
	{0x3034, 0x1a, 0, 0}, {0x3035, 0x11, 0, 0}, {0x3036, /*0x46*/0x23, 0, 0},
	...
	{0x3036, /*0x46*/0x23, 0, 0}, {0x3037, 0x13, 0, 0},
};
...
static struct reg_value ov5640_setting_30fps_VGA_640_480[] = {
	...
	{0x3036, /*0x46*/0x23, 0, 0}, {0x3037, 0x13, 0, 0}, {0x3503, 0x00, 0, 0},
};
			  ...
			  struct v4l2_subdev_format *format)
{
	...
	mode = ov5640_find_mode(frame_rate, mf->width, mf->height);
